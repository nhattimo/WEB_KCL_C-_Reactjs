...
namespace KCL_Web.Server.Migrations
{
    ...
    [Migration("20240513024840_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KCL_Web.Server.Models.Account", b =>
                {
                    b.HasOne("KCL_Web.Server.Models.Role", "Role")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("KCL_Web.Server.Models.PostingCategory", b =>
                {
                    b.HasOne("KCL_Web.Server.Models.Account", "Account")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KCL_Web.Server.Models.Account", null)
                        .WithMany()
